        ...
        <div className="flex absolute top-0 left-0 right-0 flex-wrap items-center justify-between mx-auto mr-8 ml-6" style={{ zIndex: 1000 }}>
          <div className='flex items-center'>
            ...
            <ul className='w-2/3 text-[12px] ml-4 hidden md:flex justify-center items-center gap-6 '>
              <li className='text-gray-300 hover:text-gray-500 hover:cursor-pointer'><a>Home</a></li>
              ...
              <li className='text-gray-400 hover:text-gray-500 hover:cursor-pointer'><a>My List</a></li>
            </ul>
          </div>
